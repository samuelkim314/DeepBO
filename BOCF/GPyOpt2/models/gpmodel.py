...
class GPModel_MCMC(BOModel):
    ...
    def __init__(self, kernel=None, noise_var=None, exact_feval=False, n_samples = 2, n_burnin = 50, subsample_interval = 10, step_size = 1e-1, leapfrog_steps=20, verbose=False):
        self.kernel = kernel
        self.noise_var = noise_var
        self.exact_feval = exact_feval
        self.verbose = verbose
