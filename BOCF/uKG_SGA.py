...
class uKG_SGA(AcquisitionBase):
    ...
    def __init__(self, model, space, optimizer=None, cost_withGradients=None, utility=None, normalize=False):
        ...
        super(uKG_SGA, self).__init__(model, space, optimizer, cost_withGradients=cost_withGradients)
        ...
        self.W_samples = np.random.normal(size=(7, self.n_attributes))
        self.Z_samples = np.random.normal(size=(7, self.n_attributes))
    ...
    def _marginal_acq_with_gradient(self, X, utility_params_samples):
        ...
        W_samples2 = np.random.normal(size=(1, self.n_attributes))
        Z_samples2 = np.random.normal(size=(1, self.n_attributes))
