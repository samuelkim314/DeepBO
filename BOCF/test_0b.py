...
model = multi_outputGP(output_dim=1, exact_feval=[True], fixed_hyps=True)
...
max_iter = 100
for i in range(1):
    filename = './experiments/test_CBOb1' + str(i) + '.txt'
    mabo = ma_bo.ma_BO(model, space, objective, acquisition, evaluator, initial_design)
